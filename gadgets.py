...
def cash_flow_tab_gen(begin_year,begin_month,end_year=-1,end_month=-1):    #开始结束年月
    ...
    #通讯费补助直接计入业管费-工资，不进入应付职工薪酬，需做调整
    try:
        cash_flow_dict['实际支付的业管费']=cash_flow_dict['实际支付的业管费']-cash_flow_dict['实际支付的业管费-租赁费']
        cash_flow_dict['实际支付的业管费']=cash_flow_dict['实际支付的业管费']-cash_flow_dict['实际支付的业管费-工资']
